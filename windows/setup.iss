...
OutputDir=.
SetupIconFile=dist\gui\lib\ui\images\main.ico
...
Root: HKCR; SubKey: "Molecular Network\Shell\Open\Command"; ValueType: string; ValueData: """{app}\gui.exe"" ""%1"""; Flags: uninsdeletekey
Root: HKCR; Subkey: "Molecular Network\DefaultIcon"; ValueType: string; ValueData: "{app}\gui.exe,0"; Flags: uninsdeletevalue
