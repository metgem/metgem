...
# Form implementation generated from reading ui file 'E:\git\metgem\metgem_app\ui\widgets\mds_options_widget.ui',
# licensing of 'E:\git\metgem\metgem_app\ui\widgets\mds_options_widget.ui' applies.
#
...
class Ui_gbOptions(object):
    def setupUi(self, gbOptions):
        ...
        self.spinNumIterations.setSingleStep(0)
        ...
        self.gridLayout_3.addWidget(self.chkRandomState, 4, 0, 1, 4)
    ...
    def retranslateUi(self, gbOptions):
        gbOptions.setTitle(QtWidgets.QApplication.translate("gbOptions", "MDS Visualization", None, -1))
